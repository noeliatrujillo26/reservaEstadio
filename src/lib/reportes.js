...
import { cobro_cancelado, es_cobro_credito, es_credito_vigente, requiere_factura } from './cobros'
...
export function datos_reporte({ cobros, reservas, juegos, areas, rango }) {
  ...
  return {
    rango, cs, total, credito_por_cobrar, juegos_t, reservas_t, disponibles,
