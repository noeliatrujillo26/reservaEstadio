...
const migrados = ['dashboard', 'cobros', 'seccionesreservadas', 'clientes', 'usuarios', 'movimientos', 'consumos', 'temporadas', 'descuentos', 'metodos', 'reportes', 'mensajes', 'landing', 'precios', 'cotizaciones', 'pipeline', 'completados', 'ajustes']
