...
// configuracion_panel, los parametros globales del sistema. Administrador-only
// por defecto, igual que 'usuarios': no se agrega a los perfiles de Vendedora,
// Cajero ni 'Solo lectura' de abajo.
export const perms_all = [
  'dashboard', 'clientes', 'cotizaciones', 'pipeline', 'completados',
